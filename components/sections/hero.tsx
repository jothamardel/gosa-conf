...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden py-8 sm:py-16 lg:py-20 h-screen">
      <div className="absolute inset-0">
        ...
        >
          <source
            src="https://cad1586blf8dbj3t.public.blob.vercel-storage.com/gosa"
            type="video/mp4"
          />
...
//     <video loop autoPlay muted className="h-screen w-full">
